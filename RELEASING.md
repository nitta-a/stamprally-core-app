...
1. npmで`@stamprally/core`、`@stamprally/react`、`@stamprally/ui`、`@stamprally/admin-ui`、`@stamprally/server`を公開できるアカウントまたはOrganizationを用意する。
...
4. `@stamprally/core`、`@stamprally/react`、`@stamprally/ui`、`@stamprally/admin-ui`、`@stamprally/server`をnpmへ公開する。
